...
EXCEPTION
    WHEN NO_DATA_FOUND THEN
      raise_application_error (-20001,'No records found for the restaurant and the category type.');

    WHEN OTHERS THEN
      raise_application_error (-20002,'An error has occurred when deleting the restaurant category. Please contact administrator');
